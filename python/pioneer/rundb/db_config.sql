...
CREATE TABLE IF NOT EXISTS config.pim1_epics (
    ...
    "FS13RL-R:SOL:2" FLOAT NOT NULL,
    "QSL13:SOL:2"    FLOAT NOT NULL,
    "QSL14:SOL:2"    FLOAT NOT NULL,
    "FS12-R:SOL"     INT NOT NULL,
    "FS12-L:SOL"     INT NOT NULL,
    "FS12-O:SOL"     INT NOT NULL,
    "FS12-U:SOL"     INT NOT NULL,
    "ASM12:SOL:2"    FLOAT NOT NULL,
    "TS21:SOL:2"     FLOAT NOT NULL,
    "TS22:SOL:2"     FLOAT NOT NULL,
    "QSL15:SOL:2"    FLOAT NOT NULL,
    "QSL16:SOL:2"    FLOAT NOT NULL,
...
CREATE TABLE IF NOT EXISTS config.pie5_epics (
    id INT PRIMARY KEY REFERENCES config.configuration(id),
    seq_id INT DEFAULT 0,
    "QSF41:SOL:2"      FLOAT NOT NULL,
    "HSC41:SOL:2"      FLOAT NOT NULL,
    "QSF42:SOL:2"      FLOAT NOT NULL,
    "QSF43:SOL:2"      FLOAT NOT NULL,
    "HSC42:SOL:2"      FLOAT NOT NULL,
    "QSF44:SOL:2"      FLOAT NOT NULL,
    "QSF45:SOL:2"      FLOAT NOT NULL,
    "HSC43:SOL:2"      FLOAT NOT NULL,
    "QSF46:SOL:2"      FLOAT NOT NULL,
    "QSF47:SOL:2"      FLOAT NOT NULL,
    "HSC44:SOL:2"      FLOAT NOT NULL,
    "QSF48:SOL:2"      FLOAT NOT NULL,
    "AST41:SOL:2"      FLOAT NOT NULL,
    "ASC41:SOL:2"      FLOAT NOT NULL,
    "SSL41:SOL:2"      FLOAT NOT NULL,
    "QSB41:SOL:2"      FLOAT NOT NULL,
    "QSB42:SOL:2"      FLOAT NOT NULL,
    "QSB43:SOL:2"      FLOAT NOT NULL,
    "SEP41:SOL:2"      FLOAT NOT NULL,
    "QSK41:SOL:2"      FLOAT NOT NULL,
    "QSK42:SOL:2"      FLOAT NOT NULL,
    "QSK43:SOL:2"      FLOAT NOT NULL,
    "SML41:SOL:2"      FLOAT NOT NULL,
    "SMH41:SOL:2"      FLOAT NOT NULL,
    "SMV41:SOL:2"      FLOAT NOT NULL,
    "FSH41-L:SOL"      INT NOT NULL,
    "FSH41-R:SOL"      INT NOT NULL,
    "FS42-L:SOL"       INT NOT NULL,
    "FS42-R:SOL"       INT NOT NULL,
